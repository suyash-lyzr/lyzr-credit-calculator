              ...
              llm_calls: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    node_type: { type: "string", description: "The REAL Superflow node type that makes this LLM call — one of: 'AI Agent', 'LLM', 'AI Swarm', 'A2A Agent', 'Extract Fields', 'Label Document'. (For a standalone Single Agent or Manager workload use 'AI Agent'.) Do NOT invent names." },
